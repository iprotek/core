  <!-- Navbar -->
  <nav id="top-menu" class="main-header navbar navbar-expand navbar-{{ config('iprotek.navbar_color') }} navbar-light" style="z-index:100000;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li id="apps-list-el" class="nav-item dropdown">
        <app-notifications :group_id="{{$group_id}}" :pay_account_id="{{$pay_account_id}}" current_app_name="{{config('iprotek.app_type')}}" />
        <!--
