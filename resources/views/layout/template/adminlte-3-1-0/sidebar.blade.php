  ...
  <aside id="main-sidebar" class="main-sidebar elevation-4 sidebar-{{ $theme['theme_dashboard_sidebar_color'] }}">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          ?>
          <a href="/manage/my-details" id="my-details">
        ...
        <div class="info">
          <a href="/manage/my-details" class="d-block" id="my-details"><?=$USERFULLNAME?></a>
