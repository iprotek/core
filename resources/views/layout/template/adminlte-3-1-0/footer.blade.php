...
<!-- jQuery UI 1.11.4 -->
<script src="/design/templates/adminlte3.1.0/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- ChartJS -->
<script src="/design/templates/adminlte3.1.0/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="/design/templates/adminlte3.1.0/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="/design/templates/adminlte3.1.0/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="/design/templates/adminlte3.1.0/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="/design/templates/adminlte3.1.0/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="/design/templates/adminlte3.1.0/plugins/moment/moment.min.js"></script>
<script src="/design/templates/adminlte3.1.0/plugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="/design/templates/adminlte3.1.0/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="/design/templates/adminlte3.1.0/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="/design/templates/adminlte3.1.0/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="/design/templates/adminlte3.1.0/dist/js/adminlte.js"></script>
<script src="/design/templates/adminlte3.1.0/plugins/sweetalert2/sweetalert2.min.js"></script>

<script src="/design/templates/adminlte3.1.0/plugins/select2/js/select2.min.js"></script>

<script src="/design/templates/adminlte3.1.0/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- AdminLTE for demo purposes 
<script src="/design/templates/adminlte3.1.0/dist/js/demo.js"></script>-->
<!-- AdminLTE dashboard demo (This is only for demo purposes) 
<script src="/design/templates/adminlte3.1.0/dist/js/pages/dashboard.js"></script>-->
<script>
